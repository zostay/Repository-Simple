...
B<Value Type.> Value types are represented by L<Repository::Simple::Type::Value>. These define convenience wrappers around storage types. Values are an abstraction around stored fields, which allow a stored field to be treated as complex Perl data types without requiring any additional functionality in the storage engine.

=item 4.

B<Storage Type.> Storage types are represented by L<Repository::Simple::Type::Storage>. These define the nature of fields stored in a storage engine. Storage fields represent the underlying "boxes" in which values are really stored.
...
L<Repository::Simple::Type::Node>, L<Repository::Simple::Type::Property>, L<Repository::Simple::Type::Value>, L<Repository::Simple::Type::Storage>
