...
That's all there is to it. If another system provides a similar function, you can even extend the functionality provided by it for an even easier approach (if appropriate).

=head1 METHODS

Your implementation must implement the following methods:
